...
# -*- coding: utf-8 -*-
"""
Calculate the daily means of NORA3.
"""
...
out_path = f"{path_par}/IMPETUS/NORA3/NORA3_NorthNorway_Sub/Annual_Files_DailyMean/"


#%% load file names
fn_list = sorted(glob.glob(data_path + "*.nc"))[-1:]
...
for i, fn in enumerate(fn_list):
    ...
    nc_daily = nc.resample(time="1D").mean()
    ...
    nc_daily.to_netcdf(path=out_path + f"NORA3_NorthNorway_Sub_DailyMean_{yr}.nc", mode='w')
