...
# -*- coding: utf-8 -*-
"""
Calculate the daily maxs of NORA3 rain and snow.
"""
...
#%% set path
data_path = f"{path_par}/IMPETUS/NORA3/NORA3_NorthNorway_Sub/Rain_and_Snow/"
out_path = f"{path_par}/IMPETUS/NORA3/NORA3_NorthNorway_Sub/Rain_and_Snow/DailyMax/"
...
for i, fn in enumerate(fn_list):
    ...
    nc_daily["rain"] = nc_daily["rain"] * 24
    nc_daily["snow"] = nc_daily["snow"] * 24

    # store the daily means
    nc_daily.to_netcdf(path=out_path + f"Rain_Snow_NORA3_NorthNorway_Sub_DailyMax_{yr}.nc", mode='w')
